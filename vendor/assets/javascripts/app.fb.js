...
// var urlHome='https://lavadoraswobble2013.samsung-peru.com/'//prod
...
function compartirPagina(n){
	FB.ui({
		...
		link: urlHome,
		picture: 'http://samsung-microondas-landing.development.phantasia.pe/assets/face/site.png',
		// picture: 'http://mundoativ.samsung-peru.com/images/face/site.png',
		caption: 'Samsung',
